...
const INVITATION = {
  couple: {
    bride: "සුභාෂිණී",
    groom: "අෂාන්",
    brideFull: "සුභාෂිණී ආරියරත්න",
    groomFull: "අෂාන් දුෂ්මන්ත",
  },
  date: {
    displayNumeric: "26 . 11 . 2026",
    displayLong: "වර්ෂ 2026 ක් වූ නොවැම්බර් මස 26 වන දින",
    countdownTarget: "2026-11-26T09:36:00+05:30",
  },
  time: {
    ceremonyStart: "පෙ.ව. 9:36",
    ceremonyEnd: "ප.ව. 4:00",
    registration: "පෙ.ව. 9:36",
    welcome: "පෙ.ව. 9:00",
  },
  venue: {
    name: "The Grand Chariot Hotel (Lake view)",
    city: "Ballapana, Galigamuwa",
    mapQuery: "The Grand Chariot Hotel, Ballapana",
    googleMapsLink: "https://maps.app.goo.gl/search/The+Grand+Chariot+Hotel+Ballapana",
  },
  rsvpContacts: [
    "Subhashini / Ashan - 071 309 0853",
  ],
} as const;
                ...
                >
                  ...
                  <div className="text-[#c5a059] space-y-6 max-w-3xl mx-auto leading-relaxed text-base md:text-lg">
                    <p className="text-slate-700">
                      කේ. ඒ. ඩබ්. ආරියරත්න මහතාගේ සහ ටී. එල්. සුධර්මා මහත්මියගේ ආදරණීය දියණිය වන
                    </p>
                    ...
                    <p className="text-slate-700">
                      ඩබ්. පී. නෙල්සන් කරුණාගම මහතාගේ සහ ආර්. එම්. උදය මල්ලිකා මහත්මියගේ ආදරණීය පුත් වන
                    </p>
                    <h3 className="text-3xl md:text-4xl font-bold text-[#d4af37] my-2">
                    ...
                    <div className="w-full text-left grid grid-cols-1 gap-8 relative z-10">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="pt-1">
                          ...
                          <div className="text-base md:text-lg text-[#c5a059] tracking-wide font-bold">
                            පෝරුව චාරිත්‍ර {INVITATION.time.ceremonyStart}ට<br />
                            උත්සවය {INVITATION.time.welcome} සිට {INVITATION.time.ceremonyEnd} දක්වා
                          </div>
                        </div>
                      </div>
            ...
            >
              <div className="container mx-auto px-6 max-w-5xl text-center">
                ...
                >
                  ...
                  <p className="text-sm md:text-base tracking-[0.5em] text-[#c5a059]/50 font-bold pt-12">
